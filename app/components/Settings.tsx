  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-0.5">Governance profile and risk configuration.</p>
      </div>
      ...
      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-5 space-y-5 max-w-2xl">
        ...
        <div className="space-y-1">
          <label className="text-xs font-medium text-slate-400 uppercase tracking-wider">Framework</label>
          <input
            type="text"
        ...
        <div className="pt-2 border-t border-slate-700/70 space-y-3">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wider">Presentation Mode</p>
